(function(){
  ...
  // Salary self-service
  // -----------------------------------------------------------------------
  async function loadSalaryStatement(){setStatus('salaryStatementStatus',t('payroll.loading','جاري التحميل...'));try{state.salary=await svc().loadSalaryStatement();applyPayrollReadStatus('salaryStatementStatus','salary');renderSalaryStatement();}catch(error){setStatus('salaryStatementStatus',error.message,'error');}}
  ...
  // Reference data
  // -----------------------------------------------------------------------
  async function loadReference(){setStatus('payrollReferenceStatus',t('payroll.loading','جاري التحميل...'));try{state.reference=await svc().loadReference();applyPayrollReadStatus('payrollReferenceStatus','reference');renderReference();}catch(error){setStatus('payrollReferenceStatus',error.message,'error');}}
