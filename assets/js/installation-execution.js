...
function mapButton(r){const href=String(r.customerMapUrl||'').trim();return href?`<a class="execution-primary-action installation-map-primary-action" data-execution-map="${esc(r.scheduleEntryId||r.id)}" href="${esc(href)}" target="_blank" rel="noopener noreferrer">فتح موقع العميل <span class="execution-arrow">◀</span></a>`:'<span class="installation-card-muted">لا يوجد رابط موقع مسجل</span>'}
function stepperHtml(r){const steps=[
 ...
 {label:'بدء الموعد',icon:'🔧',time:r.startedAt},
