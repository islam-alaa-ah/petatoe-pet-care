(function(){
  ...
  async function refreshCommissions(month){await rpc('refresh_payroll_commissions',{p_month:monthStart(month)},'payroll.error.refreshCommissions','تعذر إعادة احتساب العمولات');return loadCommissions(month);}
  ...
  window.PayrollService=Object.freeze({monthStart,loadManagement,prepareMonth,saveAdjustments,transition,loadSalaryStatement,loadCommissions,refreshCommissions,loadCommissionStatement,loadReference,saveEmployee,saveTier,getCache:()=>cache});
})();
