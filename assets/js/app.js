...
const views = {
  ...
  installationContactData: document.getElementById("installationContactDataView"),
  ...
  appointmentDataImport: document.getElementById("appointmentDataImportView"),
  vehicleTreasury: document.getElementById("vehicleTreasuryView"),
  payrollManagement: document.getElementById("payrollManagementView"),
  salaryStatement: document.getElementById("salaryStatementView"),
  ...
  seaVibeCustomers: document.getElementById("seaVibeCustomersView"),
  ...
  seaVibeJournals: document.getElementById("seaVibeJournalsView"),
  ...
  seaVibeTrialBalance: document.getElementById("seaVibeTrialBalanceView"),
  seaVibeIncomeStatement: document.getElementById("seaVibeIncomeStatementView"),
  seaVibeBalanceSheet: document.getElementById("seaVibeBalanceSheetView"),
...
const pageMeta = {
  ...
  appointmentDataImport: ["appointmentDataImport.title", "appointmentDataImport.note"],
  vehicleTreasury: ["خزينة السيارة", "متابعة أرصدة السيارات والإيرادات النقدية والمصروفات"],
  payrollManagement: ["إدارة الرواتب", "تجهيز واعتماد وصرف الرواتب الشهرية"],
  salaryStatement: ["كشف الراتب", "مراجعة واعتماد راتبك الحالي والرواتب السابقة"],
  ...
  seaVibeCustomers: ["عملاء SEA VIBE", "إدارة بيانات عملاء الرحلات بشكل مستقل"],
  ...
  seaVibeJournals: ["SEA VIBE — Journal Entries", "Create manual journal entries linked to the SEA VIBE chart of accounts."],
  ...
  seaVibeTrialBalance: ["SEA VIBE — ميزان المراجعة", "مراجعة أرصدة وحركات الحسابات خلال فترة محددة"],
  seaVibeIncomeStatement: ["SEA VIBE — قائمة الدخل", "الإيرادات والمصروفات وصافي نتيجة الفترة"],
  seaVibeBalanceSheet: ["SEA VIBE — قائمة المركز المالي", "الأصول والالتزامات وحقوق الملكية حتى تاريخ محدد"],
...
const PAGE_META_I18N_KEYS = Object.freeze({
  ...
  seaVibeJournals: ["seaVibe.page.journals.title", "seaVibe.page.journals.subtitle"],
  ...
  seaVibeTrialBalance: ["seaVibe.page.trialBalance.title", "seaVibe.page.trialBalance.subtitle"],
  seaVibeIncomeStatement: ["seaVibe.page.incomeStatement.title", "seaVibe.page.incomeStatement.subtitle"],
  seaVibeBalanceSheet: ["seaVibe.page.balanceSheet.title", "seaVibe.page.balanceSheet.subtitle"],
...
function switchView(requestedName, options = {}) {
  ...
  if (["payrollManagement","salaryStatement","commissionManagement","commissionStatement","payrollReference"].includes(name)) {
...
function renderDashboard() {
  ...
  const dashboardKpiIcons=[
    ...
    '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m5 12 4 4L19 6M4 21h16"/></svg>',
...
async function loadSystemSettings(force = false) {
  ...
  try {
    ...
    document.getElementById("companyNameEn").value = settings.company_name_en || "PETATOE";
...
function exportReportsCsv() {
  ...
  downloadTextFile(
    `petatoe-reports-${new Date().toISOString().slice(0, 10)}.csv`,
    csv,
...
function filteredCustomers() {
  ...
  return customers.filter(customer => !query || [customer.customerNumber,customer.name,customer.address,customer.phone,customer.googleMapsUrl].join(" ").toLowerCase().includes(query));
}
...
function exportDailyPerformanceCsv() {
  ...
  downloadTextFile(
    `petatoe-daily-performance-${report.workDate}.csv`,
...
function dailyActivityTime(value) {
  if (!value) return "—";
  return new Date(value).toLocaleTimeString("ar-SA-u-ca-gregory-nu-latn", {
    hour: "2-digit",
    minute: "2-digit"
  });
}
