(()=>{
  ...
  function render(){
    ...
    }).join(""):`<tr class="installation-completion-empty-row"><td colspan="9"><div class="empty-state">${esc(t('appointments.completion.empty','لا توجد مواعيد مكتملة بانتظار التحويل إلى فاتورة.'))}</div></td></tr>`;
  }
