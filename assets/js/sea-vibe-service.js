(function(){
  ...
  const mapRef=r=>({id:r.id,nameAr:r.name_ar||'',nameEn:r.name_en||'',isActive:r.is_active!==false,systemKey:r.system_key||'',isSystem:!!r.is_system,accountId:r.account_id||'',fuelCostAmount:num(r.fuel_cost_amount),requiresCustomer:r.requires_customer!==false,serialSeriesKey:r.serial_series_key||'standard',updatedAt:r.updated_at||r.created_at||''});
