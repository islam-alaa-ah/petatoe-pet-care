-- PETATOE P5.13.8.72 R44R38R11 — SEA VIBE Chart of Accounts Foundation
-- Adds a dynamic SEA VIBE chart of accounts and links the existing expense catalog / expense movements to posting accounts.
-- No historical migration is modified. No pruning/retention changes.
