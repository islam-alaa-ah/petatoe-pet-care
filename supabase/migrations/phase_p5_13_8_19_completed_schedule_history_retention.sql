-- Phase P5.13.8.19 — retain completed appointments in the scheduling calendar.
-- Completed/invoiced appointments are historical schedule records and must remain visible.
begin;
...
begin
  ...
  from (
    ...
    where coalesce(r.status,'') not in ('ملغي','ملغاة')
  ) q;
