-- Phase P5.12.9.1 — Free Invoice Number + Permission Group Hidden Hotfix
begin;

-- Invoice identifiers are business text identifiers: keep uniqueness, remove the obsolete nine-digit format constraint.
