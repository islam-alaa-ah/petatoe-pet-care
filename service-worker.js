const CACHE_VERSION = "petatoe-pwa-18-56-54-sea-vibe-trip-create-preview-expense-flow-r44r12-p5-13-8-72";
...
const CORE_APP_SHELL = [
  ...
  "./assets/js/sea-vibe-payroll-service.js",
...
self.addEventListener("push", event => {
  event.waitUntil((async () => {
    ...
    const title = payload.title || "PETATOE";
